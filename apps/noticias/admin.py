...
class NoticiaAdmin(admin.ModelAdmin):
    list_display = ['titulo','revista_relacionada','comentatios_link','data_postagem']
    list_display_links = ['titulo']
    search_fields = ['data_postagem','revista_relacionada','titulo','subtitulo','corpo','usuario__user']
