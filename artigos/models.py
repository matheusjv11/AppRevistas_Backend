...
from revistas.models import Edicao
...
class Artigo(models.Model):
    ...
    categoria = models.ForeignKey(
        "revistas.Categoria", on_delete=models.CASCADE)
...
class Avaliacao(models.Model):
    ...
    usuario = models.ForeignKey(
        "usuarios.Usuario", on_delete=models.CASCADE, default=None)
    artigo = models.ForeignKey(
        "artigos.Artigo", on_delete=models.CASCADE, default=None)
