...
class Noticia(models.Model):
    ...
    revista_relacionada = models.ForeignKey(
        Revista, on_delete=models.CASCADE, default=0)
    data_postagem = models.DateTimeField(default=now, editable=False)
    usuario = models.ForeignKey(
        Usuario, default=None, on_delete=models.CASCADE)
...
class Comentario(models.Model):
    ...
    usuario = models.ForeignKey(
        Usuario, default=None, on_delete=models.CASCADE, verbose_name='Usuário')
    noticia = models.ForeignKey(
        Noticia, on_delete=models.CASCADE, verbose_name='Notícia')
