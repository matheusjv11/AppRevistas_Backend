...
urlpatterns = [
    ...
    url(r'^revistas/(?P<pk>\d+)/$',
        SingleRevistaView.as_view(), name='revista-datail'),
    ...
    url(r'^categorias/(?P<pk>\d+)/$',
        SingleCategoriaView.as_view(), name='categorias-datail'),
    ...
    url(r'^revistas/(?P<revista_id>.+)/edicoes/$',
        EdicoesIDREVISTAView.as_view()),
    url(r'^edicoes/(?P<pk>\d+)/$',
        SingleEdicoesView.as_view(), name='edicoes-datail'),
